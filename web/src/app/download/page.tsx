        ...
        <div className="download-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 24, maxWidth: 1080, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            <div style={{ marginTop: 'auto' }}>
              <Link href="https://github.com/PaulJohnnn/DocuSync/releases/download/v1.0.0/DocuSync-Setup-1.0.0.exe" target="_blank" rel="noopener noreferrer" className="btn-accent" style={{
