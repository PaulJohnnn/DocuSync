...
// Validate ../../src/app/dashboard/admin/control-panel/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/dashboard/admin/control-panel">> = Specific
  const handler = {} as typeof import("../../src/app/dashboard/admin/control-panel/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/dashboard/user/my-drive/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/dashboard/user/my-drive">> = Specific
  const handler = {} as typeof import("../../src/app/dashboard/user/my-drive/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
